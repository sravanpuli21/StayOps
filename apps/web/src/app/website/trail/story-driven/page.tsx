...
// Unsplash public hotel-context photography as preview placeholders.
const IMG = {
...
export default function StoryDrivenPreview() {
  return (
    <main>
      <PreviewBadge />
      <Hero />
...
function PreviewBadge() {
  return (
    <div className="text-center py-2 px-4 text-xs" style={{ background: '#0a0a0a', color: '#fff' }}>
      ...
      Preview: <strong className="font-semibold">Direction 2 — Story-driven</strong>
    </div>
  );
}
    ...
    <section className="relative" style={{ height: 'min(78vh, 760px)' }}>
      ...
      <div className="relative z-10 h-full mx-auto max-w-6xl px-5 sm:px-8 flex flex-col justify-end pb-16 sm:pb-20 text-white">
        ...
        <div className="mt-8 flex items-center gap-3 flex-wrap">
          ...
          <Link href="#scenes" className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white" style={{ border: '1px solid rgba(255,255,255,0.5)' }}>
            See how it works
          </Link>
        </div>
      </div>
  ...
  return (
    <section id="scenes" style={{ background: '#0a0a0a', color: '#fff' }}>
      <div className="mx-auto max-w-6xl px-5 sm:px-8 py-20 sm:py-28">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-5">
          {scenes.map((s) => (
            <div key={s.eyebrow} className="rounded-2xl overflow-hidden" style={{ background: '#141414', border: '1px solid #222' }}>
              ...
              <div className="p-5">
                <p className="text-[11px] font-semibold uppercase tracking-[0.14em]" style={{ color: '#ff385c' }}>
                  {s.eyebrow}
                </p>
                <p className="mt-2 text-lg font-semibold" style={{ color: '#fff', lineHeight: 1.3 }}>
                  {s.headline}
                </p>
        ...
        <p className="mt-12 text-lg sm:text-xl" style={{ color: '#c1c1c1', lineHeight: 1.5, maxWidth: '42ch' }}>
    ...
    <section className="relative overflow-hidden" style={{ background: '#f5f2ec' }}>
      ...
      <div className="relative mx-auto max-w-4xl px-5 sm:px-8 py-20 sm:py-28">
        ...
        <h2
          ...
          style={{ color: '#0a0a0a', fontSize: 'clamp(1.75rem, 3.5vw, 2.75rem)', lineHeight: 1.12, letterSpacing: '-0.02em' }}
        >
  ...
  return (
    <section className="relative" style={{ height: 'min(60vh, 560px)' }}>
      ...
      <div className="relative z-10 h-full mx-auto max-w-4xl px-5 sm:px-8 flex flex-col justify-center items-center text-center text-white">
        <h2
          style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', lineHeight: 1.08, letterSpacing: '-0.025em', fontWeight: 600, maxWidth: '22ch' }}
        >
