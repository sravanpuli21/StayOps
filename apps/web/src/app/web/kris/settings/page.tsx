...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center py-24">
      ...
      <h1 className="text-xl font-bold mb-1" style={{ color: '#222222' }}>usettings</h1>
      <p className="text-sm mb-6" style={{ color: '#6a6a6a' }}>This module is coming in the next phase.</p>
      <Link href="/web/kris/dashboard" className="text-sm font-semibold underline" style={{ color: '#ff385c' }}>
        ← Back to Dashboard
      </Link>
    </div>
  );
